...
int maximum_bits;
float Irms;
float offset = 157; //Modificar este offset para ajustar la corriente
int inPinI;
int sampleI;
...
values["T13"] = round2(temperatureC);
values["V13"] = round2(value);
values["C13"] = round2(Irms3);
char output[128];
