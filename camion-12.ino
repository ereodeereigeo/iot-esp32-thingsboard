...
int maximum_bits;
float Irms;
float offset = 156; //Modificar este offset para ajustar la corriente
int inPinI;
int sampleI;
...
values["T12"] = round2(temperatureC);
values["V12"] = round2(value);
values["C12"] = round2(Irms3);
char output[128];
