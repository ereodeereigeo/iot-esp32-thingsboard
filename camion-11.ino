...
int maximum_bits;
float Irms;
float offset = 170; //Modificar este offset para ajustar la corriente
int inPinI;
int sampleI;
...
values["T11"] = round2(temperatureC);
values["V11"] = round2(value);
values["C11"] = round2(Irms3);
char output[128];
