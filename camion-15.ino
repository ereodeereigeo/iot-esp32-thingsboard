...
int maximum_bits;
float Irms;
float offset = 163; //Modificar este offset para ajustar la corriente
int inPinI;
int sampleI;
...
values["T15"] = round2(temperatureC);
values["V15"] = round2(value);
values["C15"] = round2(Irms3);
char output[128];
